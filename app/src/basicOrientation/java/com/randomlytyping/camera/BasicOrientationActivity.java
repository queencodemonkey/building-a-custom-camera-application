...
/**
 * The BasicOrientationActivity class demonstrates how to handle orientation in regards to the
 * camera preview and picture orientation.
 * <p/>
 * Created by Huyen Tue Dao on 05/01/14.
 *
 * @author Huyen Tue Dao
 */
public class BasicOrientationActivity extends Activity implements View.OnClickListener {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_orientation);
